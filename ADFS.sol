...
contract TronAdfs {
    ...
    address payable public project_side4;
    address payable public project_side5;
	...
	uint256 public xmnsIssueBase = 3e13;
    ...
    constructor(address payable _owner) public {
        ...
        project_side1 = 0xaE799b679b31F77A3deD81D0fBfF831eDE98DE01;
        project_side2 = 0x86CCa03967137F3B155e751a8cD3123a515e8c33;
        project_side3 = 0x29AF07F95595F3BBF56dAfddDD5E539680170A0d;
        project_side4 = 0x1433C5a0bcCB72C37806eaa8c5B4E22BF4E39C15;
        project_side5 = 0x51Ce4C158255F1D43B1639b9A34c1bb564C84597;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        if(pool_last_draw + 1 days < block.timestamp) {
            _drawPool();
			xmnsTOtrx = xmnsTOtrx * 1005 /1000;
        }
		project_side1.transfer(_amount * 1 / 100);
		project_side2.transfer(_amount * 1 / 100);
		project_side3.transfer(_amount * 1 / 100);
		project_side4.transfer(_amount * 1 / 100);
		project_side5.transfer(_amount * 1 / 100);
		if(fundRate > 0){
		...
		if(totalLevel > 0 && xmnsTotalLevelMap[totalLevel] != true){
			totalXmnsBalance = totalXmnsBalance + 1e10;
		}else{
